...
<section id="umowiony" class="auto-height photo">
                ...
                <section id="doctor-photos" class="container-fluid no-padding extra-margin-lg">
                    ...
                    <div id="clock-male-doctor" class="column"><img src="<?php echo $this->webroot; ?>images/umowiony-mobile/photo_5.jpg" alt="doctor photo2" /><img src="<?php echo $this->webroot; ?>images/umowiony-mobile/photo_4.jpg" alt="doctor photo6" /></div>
                    <div id="stetoscope" class="column"><img src="<?php echo $this->webroot; ?>images/umowiony-mobile/photo_2.jpg" alt="doctor photo3" /></div>
                    <div id="form-tablet" class="column"><img src="<?php echo $this->webroot; ?>images/umowiony-mobile/photo_6.jpg" alt="doctor photo4" /><img src="<?php echo $this->webroot; ?>images/umowiony-mobile/photo_7.jpg" alt="doctor photo7" /></div>
                    <div id="assistant" class="column hidden-xs"><img src="<?php echo $this->webroot; ?>images/umowiony-mobile/photo_3.jpg" alt="doctor photo5" /></div>
                </section>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="box">
                                        <img src="<?php echo $this->webroot; ?>images/umowiony-mobile/ico_task.png" alt="task-icon"/>
                                        <h3><?php echo __("umowiony_tasks_title");?></h3>
                                        <p><?php echo __("umowiony_tasks_line 1"); ?></p>
                                        <p><?php echo __("umowiony_tasks_line 2"); ?></p>                                                                           
                                    <div class="box">
                                        <img src="<?php echo $this->webroot; ?>images/umowiony-mobile/ico_time.png" alt="time-icon" />
                                ...
                                <div class="col-md-6">
                                    <div class="box">
                                        <img src="<?php echo $this->webroot; ?>images/umowiony-mobile/ico_bugs.png" alt="bug-icon"/>
                                        <h3><?php echo __("umowiony_bugs_title");?></h3>
                                        <p><?php echo __("umowiony_bugs_line 1"); ?></p>
                                        <p><?php echo __("umowiony_bugs_line 2"); ?></p>
                                    </div>
                                    <div class="box">
                                        <img src="<?php echo $this->webroot; ?>images/umowiony-mobile/ico_page.png" alt="page-icon"/>
