...
<section id="landing-projects" class="auto-height photo container-fluid text-center">
    <div class="page-title">
        <div class="hr-up"></div>
        <p><a class="ajax" href="<?php echo $this->webroot; ?>projects"><span class="hidden-xs hidden-sm"><?php echo __("landing_projects");?></span><span class="hidden-md hidden-lg"><?php echo __("landing_projects_mobile");?></span></a></p>
        <div class="hr-down"></div>
    </div>
    <div class="subpage-footer center-content">
        <a href="<?php echo $this->webroot; ?>projects" class="stdbtn ajax"><?php echo __("landing_projects_button");?></a>
    </div>
</section>
...
<section id="landing-meet-us" class="auto-height photo container-fluid text-center">
    <div class="page-title">
        <div class="hr-up"></div>
        <p><a class="ajax" href="<?php echo $this->webroot; ?>contact"><span class="hidden-xs hidden-sm"><?php echo __("landing_contact");?></span><span class="hidden-md hidden-lg"><?php echo __("landing_contact_mobile");?></span></a></p>
        <div class="hr-down"></div>
    </div>
    <div class="subpage-footer center-content">
        <a href="<?php echo $this->webroot; ?>contact" class="stdbtn ajax"><?php echo __("landing_contact_button");?></a>
    </div>
</section>
<section id="landing-journal" class="auto-height photo container-fluid text-center">
    <div class="page-title">
        <div class="hr-up"></div>
        <p><a class="ajax" href="<?php echo $this->webroot; ?>journal"><span class="hidden-xs hidden-sm"><?php echo __("landing_journal");?></span><span class="hidden-md hidden-lg"><?php echo __("landing_journal_mobile");?></span></a></p>
        <div class="hr-down"></div>
    </div>
    <div class="subpage-footer center-content">
        <a href="<?php echo $this->webroot; ?>journal" class="stdbtn ajax"><?php echo __("landing_journal_button");?></a>
    </div>
</section>
<section id="landing-planner" class="auto-height photo container-fluid text-center">
    <div class="page-title">
        <div class="hr-up"></div>
        <p><a class="ajax" href="<?php echo $this->webroot; ?>projectplanner"><span class="hidden-xs hidden-sm"><?php echo __("landing_project_planner");?></span><span class="hidden-md hidden-lg"><?php echo __("landing_project_planner_mobile");?></span></a></p>
        <div class="hr-down"></div>
    </div>
    <div class="subpage-footer center-content">
        <a href="<?php echo $this->webroot; ?>projectplanner" class="stdbtn ajax"><?php echo __("landing_project_planner_button");?></a>
    </div>
</section>